...
int lua_cocos2dx_experimental_webview_WebView_setBackgroundColor(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::experimental::ui::WebView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_experimental_webview_WebView_setBackgroundColor'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 4) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ccexp.WebView:setBackgroundColor");

        ok &= luaval_to_int32(tolua_S, 3,(int *)&arg1, "ccexp.WebView:setBackgroundColor");

        ok &= luaval_to_int32(tolua_S, 4,(int *)&arg2, "ccexp.WebView:setBackgroundColor");

        ok &= luaval_to_int32(tolua_S, 5,(int *)&arg3, "ccexp.WebView:setBackgroundColor");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_experimental_webview_WebView_setBackgroundColor'", nullptr);
            return 0;
        }
        cobj->setBackgroundColor(arg0, arg1, arg2, arg3);
        return 0;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccexp.WebView:setBackgroundColor",argc, 4);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_experimental_webview_WebView_setBackgroundColor'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_experimental_webview_WebView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"WebView");
        ...
        tolua_function(tolua_S,"setBackgroundColor",lua_cocos2dx_experimental_webview_WebView_setBackgroundColor);
